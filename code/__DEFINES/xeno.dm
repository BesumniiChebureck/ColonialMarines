...
#define XENO_EXPOSIVEARMOR_MOD_OVERLARGE  150
...
#define XENO_MULTIPLIER_HEALTH_MATURE 1.75
#define XENO_MULTIPLIER_HEALTH_ELDER 2.5
#define XENO_MULTIPLIER_HEALTH_ANCIENT 3.25
#define XENO_MULTIPLIER_HEALTH_PRIMORDIAL 4.0

#define XENO_MULTIPLIER_DAMAGE_YOUNG 1.0
#define XENO_MULTIPLIER_DAMAGE_MATURE 1.5
#define XENO_MULTIPLIER_DAMAGE_ELDER 2.25
#define XENO_MULTIPLIER_DAMAGE_ANCIENT 2.75
#define XENO_MULTIPLIER_DAMAGE_PRIMORDIAL 3.5

#define XENO_MULTIPLIER_PLASMA_YOUNG 1.0
#define XENO_MULTIPLIER_PLASMA_MATURE 1.5
#define XENO_MULTIPLIER_PLASMA_ELDER 2.25
#define XENO_MULTIPLIER_PLASMA_ANCIENT 3.0
#define XENO_MULTIPLIER_PLASMA_PRIMORDIAL 4.1

#define XENO_MULTIPLIER_CRYSTAL_YOUNG 1.0
#define XENO_MULTIPLIER_CRYSTAL_MATURE 1.25
#define XENO_MULTIPLIER_CRYSTAL_ELDER 1.5
#define XENO_MULTIPLIER_CRYSTAL_ANCIENT 1.75
#define XENO_MULTIPLIER_CRYSTAL_PRIMORDIAL 2.3

#define XENO_MULTIPLIER_PLASMA_GAIN_YOUNG 1.0
#define XENO_MULTIPLIER_PLASMA_GAIN_MATURE 1.4
#define XENO_MULTIPLIER_PLASMA_GAIN_ELDER 1.8
#define XENO_MULTIPLIER_PLASMA_GAIN_ANCIENT 2.2
#define XENO_MULTIPLIER_PLASMA_GAIN_PRIMORDIAL 2.6

#define XENO_MULTIPLIER_ARMOR_FACTOR_YOUNG 0.6
#define XENO_MULTIPLIER_ARMOR_FACTOR_MATURE 1.2
#define XENO_MULTIPLIER_ARMOR_FACTOR_ELDER 1.6
#define XENO_MULTIPLIER_ARMOR_FACTOR_ANCIENT 1.8
#define XENO_MULTIPLIER_ARMOR_FACTOR_PRIMORDIAL 2.5
...
#define XENO_MULTIPLIER_EVASION_ANCIENT 2.0
#define XENO_MULTIPLIER_EVASION_PRIMORDIAL 2.4
