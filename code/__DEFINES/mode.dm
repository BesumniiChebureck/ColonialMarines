...
#define WHITELIST_CREWMAN			1024
#define WHITELIST_CREWMAN_COUNCIL	2048
#define WHITELIST_CREWMAN_LEADER	4096

#define WHITELIST_MENTOR			8192
#define WHITELISTS_GENERAL				(WHITELIST_YAUTJA|WHITELIST_COMMANDER|WHITELIST_SYNTHETIC|WHITELIST_CREWMAN|WHITELIST_MENTOR)
#define WHITELISTS_COUNCIL				(WHITELIST_YAUTJA_COUNCIL|WHITELIST_COMMANDER_COUNCIL|WHITELIST_SYNTHETIC_COUNCIL|WHITELIST_CREWMAN_COUNCIL)
#define WHITELISTS_LEADER				(WHITELIST_YAUTJA_LEADER|WHITELIST_COMMANDER_LEADER|WHITELIST_SYNTHETIC_LEADER|WHITELIST_CREWMAN_LEADER)
