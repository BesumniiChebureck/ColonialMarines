...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(var/scale)
	listed_products = list(
		...
		list("Shoulder Holster", round(scale * 2), /obj/item/clothing/accessory/holster, VENDOR_ITEM_REGULAR),
		list("Webbing", round(scale * 4), /obj/item/clothing/accessory/storage/webbing, VENDOR_ITEM_REGULAR),
		...
		list("First-Aid Pouch (Full)", round(scale * 4), /obj/item/storage/pouch/firstaid/full, VENDOR_ITEM_REGULAR),
		list("Flare Pouch (Full)", round(scale * 4), /obj/item/storage/pouch/flare/full, VENDOR_ITEM_REGULAR),
		list("Fuel Tank Strap Pouch", round(scale * 4), /obj/item/storage/pouch/flamertank, VENDOR_ITEM_REGULAR),
		list("Large Pistol Magazine Pouch", round(scale * 4), /obj/item/storage/pouch/magazine/pistol/large, VENDOR_ITEM_REGULAR),
		...
		list("Sidearm Pouch", round(scale * 4), /obj/item/storage/pouch/pistol, VENDOR_ITEM_REGULAR),
		...
		list("M240 Pyrotechnician Support Kit", round(scale * 4), /obj/item/storage/box/kit/mini_pyro, VENDOR_ITEM_REGULAR),
		...
		list("M-OU53 Field Test Kit", round(scale * 4), /obj/item/storage/box/kit/mou53_sapper, VENDOR_ITEM_REGULAR),
		list("Combat Technician Support Kit", round(scale * 4), /obj/item/storage/box/kit/mini_engineer, VENDOR_ITEM_REGULAR),
		list("First Responder Medical Support Kit", round(scale * 4), /obj/item/storage/box/kit/mini_medic, VENDOR_ITEM_REGULAR),
		list("Frontline Grenadier Kit", round(scale * 4), /obj/item/storage/box/kit/mini_grenadier, VENDOR_ITEM_REGULAR),
		list("L42A Sniper Kit", round(scale * 4), /obj/item/storage/box/kit/mini_sniper, VENDOR_ITEM_REGULAR),
		list("Personal Self Defense Kit", round(scale * 1), /obj/item/storage/box/kit/self_defense, VENDOR_ITEM_REGULAR),
		list("M2C Heavy Gunner Kit", round(scale * 4), /obj/item/storage/box/kit/machinegunner, VENDOR_ITEM_REGULAR),

		list("EXPLOSIVES", -1, null, null),
		list("M15 Fragmentation Grenade", round(scale * 4), /obj/item/explosive/grenade/HE/m15, VENDOR_ITEM_REGULAR),
		list("M20 Claymore Anti-Personnel Mine", round(scale * 4), /obj/item/explosive/mine, VENDOR_ITEM_REGULAR),
		list("M40 HEDP Grenade Box", round(scale * 2), /obj/item/storage/box/nade_box, VENDOR_ITEM_REGULAR),
		list("M40 HEFA grenade box", round(scale * 1), /obj/item/storage/box/nade_box/frag, VENDOR_ITEM_REGULAR),
		list("M40 HIDP Incendiary Grenade", round(scale * 6), /obj/item/explosive/grenade/incendiary, VENDOR_ITEM_REGULAR),
		list("M40 HSDP Smoke Grenade", round(scale * 6), /obj/item/explosive/grenade/smokebomb, VENDOR_ITEM_REGULAR),

		list("MISCELLANEOUS", -1, null, null),
		list("Combat Flashlight", round(scale * 6), /obj/item/device/flashlight/combat, VENDOR_ITEM_REGULAR),
		...
		list("M89-S Signal Flare Pack", round(scale * 4), /obj/item/storage/box/m94/signal, VENDOR_ITEM_REGULAR),
		...
		list("MB-6 Folding Barricade", round(scale * 8), /obj/item/folding_barricade, VENDOR_ITEM_REGULAR),
		list("Motion Detector", round(scale * 4), /obj/item/device/motiondetector, VENDOR_ITEM_REGULAR),
		list("Binoculars", round(scale * 4), /obj/item/device/binoculars/range/designator, VENDOR_ITEM_REGULAR),
		list("Plastic Explosive", round(scale * 10), /obj/item/explosive/plastic, VENDOR_ITEM_REGULAR)
		)
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad/populate_product_list(var/scale)
	listed_products = list(
		...
		list("POUCHES", -1, null, null),
		list("Construction Pouch", round(scale * 1), /obj/item/storage/pouch/construction, VENDOR_ITEM_REGULAR),
		list("Document Pouch", round(scale * 1), /obj/item/storage/pouch/document/small, VENDOR_ITEM_REGULAR),
		list("Explosive Pouch", round(scale * 1), /obj/item/storage/pouch/explosive, VENDOR_ITEM_REGULAR),
		list("First-Aid Pouch (Full)", round(scale * 2), /obj/item/storage/pouch/firstaid/full, VENDOR_ITEM_REGULAR),
		list("Flare Pouch (Full)", round(scale * 2), /obj/item/storage/pouch/flare/full, VENDOR_ITEM_REGULAR),
		...
		list("Medical Pouch", round(scale * 1), /obj/item/storage/pouch/medical, VENDOR_ITEM_REGULAR),
		list("Large General Pouch", round(scale * 1), /obj/item/storage/pouch/general/large, VENDOR_ITEM_REGULAR),
		list("Medkit Pouch", round(scale * 1), /obj/item/storage/pouch/medkit, VENDOR_ITEM_REGULAR),
		list("Sidearm Pouch", round(scale * 2), /obj/item/storage/pouch/pistol, VENDOR_ITEM_REGULAR),
		list("Syringe Pouch", round(scale * 1), /obj/item/storage/pouch/syringe, VENDOR_ITEM_REGULAR),
		list("Tools Pouch (Full)", round(scale * 1), /obj/item/storage/pouch/tools/full, VENDOR_ITEM_REGULAR),
		...
		list("Personal Self Defense Kit", round(scale * 1), /obj/item/storage/box/kit/self_defense, VENDOR_ITEM_REGULAR),
		list("M2C Heavy Gunner Kit", round(scale * 1), /obj/item/storage/box/kit/machinegunner, VENDOR_ITEM_REGULAR),
		...
		list("M40 HSDP Smoke Grenade", round(scale * 3), /obj/item/explosive/grenade/smokebomb, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/populate_product_list(var/scale)
	listed_products = list(
		...
		list("M39 HV Magazine (10x20mm)", round(scale * 8), /obj/item/ammo_magazine/smg/m39, VENDOR_ITEM_REGULAR),
		list("M41A Magazine (10x24mm)", round(scale * 8), /obj/item/ammo_magazine/rifle, VENDOR_ITEM_REGULAR),
		list("M44 Speed Loader (.44)", round(scale * 6), /obj/item/ammo_magazine/revolver, VENDOR_ITEM_REGULAR),
		list("M4A3 Magazine (9mm)", round(scale * 6), /obj/item/ammo_magazine/pistol, VENDOR_ITEM_REGULAR),

		list("ARMOR-PIERCING AMMUNITION", -1, null, null),
		list("88 Mod 4 AP Magazine (9mm)", round(scale * 6), /obj/item/ammo_magazine/pistol/mod88, VENDOR_ITEM_REGULAR),
		list("L42A AP Magazine (10x24mm)", round(scale * 4), /obj/item/ammo_magazine/rifle/l42a/ap, VENDOR_ITEM_REGULAR),
		list("M39 AP Magazine (10x20mm)", round(scale * 4), /obj/item/ammo_magazine/smg/m39/ap, VENDOR_ITEM_REGULAR),
		list("M41A AP Magazine (10x24mm)", round(scale * 4), /obj/item/ammo_magazine/rifle/ap, VENDOR_ITEM_REGULAR),
		...
		list("M39 Extended Magazine (10x20mm)", round(scale * 3) + 3, /obj/item/ammo_magazine/smg/m39/extended, VENDOR_ITEM_REGULAR),
		list("M41A Extended Magazine (10x24mm)", round(scale * 3), /obj/item/ammo_magazine/rifle/extended, VENDOR_ITEM_REGULAR),

		list("SPECIAL AMMUNITION", -1, null, null),
		list("Incinerator Tank", round(scale * 4), /obj/item/ammo_magazine/flamer_tank, VENDOR_ITEM_REGULAR),
		list("large incinerator tank", round(scale * 2), /obj/item/ammo_magazine/flamer_tank/large, VENDOR_ITEM_REGULAR),
		list("large incinerator tank (B)", round(scale * 1), /obj/item/ammo_magazine/flamer_tank/large/B, VENDOR_ITEM_REGULAR),
		list("large incinerator tank (X)", round(scale * 1), /obj/item/ammo_magazine/flamer_tank/large/X, VENDOR_ITEM_REGULAR),
		list("M56 Powerpack", round(scale * 4), /obj/item/smartgun_powerpack, VENDOR_ITEM_REGULAR),
		list("M56 Smartgun Drum", round(scale * 4), /obj/item/ammo_magazine/smartgun, VENDOR_ITEM_REGULAR),
		...
		list("Rifle Ammunition Box (10x24mm)", round(scale * 1), /obj/item/ammo_box/rounds, VENDOR_ITEM_REGULAR),
		list("Rifle Ammunition Box (10x24mm AP)", round(scale * 1), /obj/item/ammo_box/rounds/ap, VENDOR_ITEM_REGULAR),
		list("SMG Ammunition Box (10x20mm HV)", round(scale * 1), /obj/item/ammo_box/rounds/smg, VENDOR_ITEM_REGULAR),
		...
		list("Magazine Box (Ext M39 x 10)", round(scale * 1), /obj/item/ammo_box/magazine/m39/ext, VENDOR_ITEM_REGULAR),
		list("Magazine Box (Ext M41A x 8)", round(scale * 1), /obj/item/ammo_box/magazine/ext, VENDOR_ITEM_REGULAR),
		list("Magazine Box (L42A x 16)", round(scale * 1), /obj/item/ammo_box/magazine/l42a, VENDOR_ITEM_REGULAR),
		list("Magazine Box (M39 x 12)", round(scale * 1), /obj/item/ammo_box/magazine/m39, VENDOR_ITEM_REGULAR),
		list("Magazine Box (M41A x 10)", round(scale * 1), /obj/item/ammo_box/magazine, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/squad/populate_product_list(var/scale)
	listed_products = list(
		...
		list("EXTENDED AMMUNITION", -1, null, null),
		list("M39 Extended Magazine (10x20mm)", round(scale * 4), /obj/item/ammo_magazine/smg/m39/extended, VENDOR_ITEM_REGULAR),
		list("M41A Extended Magazine (10x24mm)", round(scale * 4), /obj/item/ammo_magazine/rifle/extended, VENDOR_ITEM_REGULAR),
